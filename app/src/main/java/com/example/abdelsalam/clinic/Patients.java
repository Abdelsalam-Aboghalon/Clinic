...
public class Patients extends AppCompatActivity {
        ...
        try
        {
            ...
            alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    String s = clinic.insert2(Integer.parseInt(e1.getText().toString()), e2.getText().toString(), e3.getText().toString(), e4.getText().toString(), Integer.parseInt(e5.getText().toString()));
                    clear();
                    operation.setText(s);
                }
            });
    ...
    public void onShow(View view)
    {
        ...
        Cursor c = clinic.AllData_table2();
    ...
    {
        try {
            String s = clinic.updateNameT2(Integer.parseInt(e1.getText().toString()), e2.getText().toString());
            operation.setText(s);
        }catch (Exception e)
        {
